...
def init_model(device, model_path):
    ...
    cfg = check_point['cfg']
    model = myNet_ocr_color(num_classes=len(plate_chr), export=True, cfg=cfg, color_num=5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='../weights/plate_rec_color.pth',
                        help='model.pt path(s)')
    parser.add_argument('--image_path', type=str, default='../license_imgs',
                        help='source')
    ...
    parser.add_argument('--acc', type=bool, default='True', help=' get accuracy')
