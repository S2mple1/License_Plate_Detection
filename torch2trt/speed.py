...
if __name__ == '__main__':
    ...
    parser.add_argument('--torch_path', type=str, required=True, help='torch model path')
    parser.add_argument('--trt_path', type=str, required=True, help='tensorrt model path')

    parser.add_argument('--device', type=int, default=0, help='cuda device')
    parser.add_argument('--img_shape', type=list, default=[1, 3, 640, 640], help='tensorrt model path')
